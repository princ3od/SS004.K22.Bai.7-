...
using namespace std;
enum class Symbol { LONG_BIG_BLOCK = 219, SQUARE_BLOCK = 254, LONG_THIN_LEFT_BLOCK = 222, LONG_THIN_RIGHT_BLOCK = 221, LONG_TOP_BLOCK = 220, LONG_BOTTOM_BLOCK = 223, APPLE = 153 };
...
enum class Color {RED = 0, GREEN = 1, BLUE = 2, YELLOW = 3, PURPLE = 4};

//game mode 
enum class GameMode { EASY = 0, NORMAL = 1, HARD = 2, SPECIAL = 3 };

//thua neu gia tri am
enum class MapData {WALL = -2, SNAKE = -1, NOTHING = 0};

enum class SnakeDirection { RIGHT = 0, UP = 1, LEFT = 2, DOWN = 3, EXIT = -1 };
...
//(-1, 0) = trai
//(0, 1) = xuong
short int prevInput = LEFT;
short int input = LEFT;	//bien toan cuc de lay input
short int item = NOTHING;
